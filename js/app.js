    ...
    importActivityData(activity) {
        try {
            ...
            if (diferencaTempos > 10)
                alert('De acordo com o STRAVA, o tempo decorrido desta corrida foi maior que o tempo de movimentação. Lembre de indicar ao BRAVØS se houve ou não pausa total!');
